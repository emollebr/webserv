...
Request::Request(char *buffer, int client, int bytesRead, ServerConfig config) : _pendingResponse(0), _bytesSent(0),  _errorPages(config.getErrorPages()), _redirStatus(0), _statusCode(200), client(client) {
